...
## s- signal## fp - frequency of a file 
[s, fp] = auload('A.wav');
...
## figure = new window with plot
 ...
 file1 = ['A' , int2str(BITS), '.wav'];
 file2 = ['A' , int2str(BITS + 1), '.wav'];
 ...
 ## function determines  to which top to the power of raise a number to 
 ## be greater than N
 ...
 ## fourier transfomate of final signal on frequanzy from 0 to 48 kHz
...
print(['A_Fig. 1 - Plots of signals original sampled and noise.png'], "-dpng", '-S1600,900');       
...
ausave(['A_filtered.wav'], s_filtered_mono, fp); 
...
print(['A_Fig. 2 - Plots of filter FIR.png'],"-dpng", '-S1600,900'); 
